...
class ModernStrategyAdapter:
    ...
    def __init__(self, strategy: Union[GridTradingStrategy, SmartDCAStrategy,
                                     AutomatedMarketMakingStrategy, TriangularArbitrageStrategy]):
            ...
            if isinstance(self.strategy, SmartDCAStrategy):
                ...
                if opportunity:
                    result = self.strategy.execute_arbitrage(
                        opportunity,
                        trade_size=trade_result.get('trade_size', 1000)
                    )
...
def create_modern_strategy_adapter(
    strategy_type: str,
    **kwargs
