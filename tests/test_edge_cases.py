...
class TestKnowledgeGraphEdgeCases:
    ...
    def test_query_with_empty_result(self, neo4j_config):
    ...
    def test_query_with_large_dataset(self, neo4j_config):
    ...
    def test_multiple_queries_same_session(self, neo4j_config):
    ...
    def test_write_with_multiple_statements(self, neo4j_config):
        """Test write operations with multiple Cypher statements."""
        from graphwiz_trader.graph import KnowledgeGraph
        ...
        statements = [
            "CREATE (n:Asset {symbol: 'BTC'})",
            "CREATE (n:Asset {symbol: 'ETH'})",
            "CREATE (n:Asset {symbol: 'XRP'})"
        ]

        for statement in statements:
            result = kg.write(statement)
